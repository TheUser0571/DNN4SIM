...
% wf=              -> Boolean true to add a widefield image in the SIM acquisition
%
% -- Acquisition
...
fc=2*Na/lamb*res;
if length(sz)==3
    setConfigFilePSF(sz(2),sz(1),sz(3),res,resZ,Na,lamb);
    psf = PSFGenerator.compute('/home/esoubies/Bureau/simrecons/DataGeneration/config.txt');psf=psf/sum(psf(:));
